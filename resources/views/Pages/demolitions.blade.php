                            ...
                            <tr>
                                <td>
                                    <span class="text-left" style="display: inline-grid">
                                        ...
                                        <span>Demolition Type: {{$demolition->types->first()->name}}</span>
                                ...
                                <td style="padding: 35px 0">
                                    <button class="btn btn-{{preg_replace('/\s+/', '-', lcfirst($demolition->status->name))}}">
                                ...
                                <td style="padding: 20px 0">
                                    <form action="{{ route('demolitions.active', $demolition) }}"
                                          method="POST" style="display:inline-grid;">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                                        <a href="{{ route('demolitions.edit', $demolition) }}"
                                           class="btn btn-link"><span
                                                    class="fa fa-edit"></span> View/Edit</a>
                                        <button type="submit" class="btn btn-link"><span
                                                    class="fa fa-eye"> Active</span>
                                        </button>
                                    </form>
                                </td>
                            </tr>
