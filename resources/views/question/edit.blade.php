                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" name="question" id="question" class="form-control" value="{{ old('question', $question->question) }}">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="status" name="status" value="{{ old('status', $question->status) }}">>
